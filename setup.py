...
from transmissions import __version__ as version_string  # noqa: E402
...
description = "Ranger Radio Transmission Indexer"
...
entry_points = {
    "console_scripts": ["rtx = transmissions.run:Command.main"],
}
